...
//        *hashtable_ = HashTable<I, V> (function, size_);
//        hashtable_ = h;?
    };
 //+ get - и удаление из очереди и хэш таблицы - в любом методе кеша
 // и берем и хэш таблицы

// push - + проверка по очереди есть ли он уже
// get - возвращает ссылку на валуе из хэнтаблицы + проверка в (можно не делать);
